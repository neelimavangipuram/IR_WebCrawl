...
public class MyCrawler extends WebCrawler {
	...
	protected void handlePageStatusCode(WebURL webUrl, int statusCode, String statusDescription) {
		...
		try(FileWriter fw = new FileWriter("fetch_NewsDay.csv", true)) {
	...
	public void visit(Page page) {
		...
		System.out.println("URL: " + CrawlStat.statusCode_s + ":" + url);
...
//            String text = htmlParseData.getText();
			...
			try(FileWriter fw = new FileWriter("visit_NewsDay.csv", true)) {
	...
	public boolean shouldVisit(Page referringPage, WebURL url) {
		...
		try(FileWriter fw = new FileWriter("urls_NewsDay.csv", true)) {
	...
	public Object getMyLocalData() {
		...
		//System.out.println(CrawlStat.statusCode_s + "--" + CrawlStat.urlInside);
