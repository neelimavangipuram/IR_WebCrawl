...
public class Controller {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String crawlStorageFolder = "C:/Users/neeli/Desktop/Ref_1";
        int numberOfCrawlers = 7;
        int maxDepthOfCrawling = 16;
        int maxPagesToFetch = 20000;
        //int politenessDelay = 200;
        String name = "Neelima Vangipuram";
        ...
        config.setUserAgentString(name);
        ...
        //System.out.println("Local Data" + crawlersLocalData.get(0));
        
        PrintWriter writer = new PrintWriter("CrawlReport_NewsDay.txt", "UTF-8");
        writer.println("Name: Siddalingesha Devarmani Shivakumar");
        writer.println("UCS ID: 2468399620");
        writer.println("News site crawled: newsday.com");
        writer.println("");
        ...
        if(((Object[])(crawlersLocalData.get(0)))[2] instanceof HashMap) {
        	for(HashMap.Entry<Integer, Integer> item : ((HashMap<Integer, Integer>)((Object[])(crawlersLocalData.get(0)))[2]).entrySet()) {
        		...
        		writer.println(description + ": " + item.getValue());
        	}
        }    	
